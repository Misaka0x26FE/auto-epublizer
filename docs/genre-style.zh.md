...
| 文体 | 文档 | 核心特殊优化 |
|---|---|---|
| 小说叙事 | [novel.md](genres/novel.zh.md) | 角色圣经 + source-only 术语 + 敬称策略 + 对话辨识度 + 前文滚动衔接 |
| 学术专著 | [academic.md](genres/academic.zh.md) | 学科术语统一 + 索引边码 + 缩略语加注 + 参考文献不译 + 数字单位规范 |
| 论文（IMRaD） | [paper.md](genres/paper.zh.md) | IMRaD 结构 + 结果/讨论分离 + 缩略语加注 + 可复现 |
| 诗歌/散文 | [poetry.md](genres/poetry.zh.md) | 行结构保留 + 意象优先 + 韵脚策略声明 |
| 报刊/期刊 | [newspaper.md](genres/newspaper.zh.md) | 按版面组织 + 标题导语化 + 事实/引语准确 + 客观转达 |
