> **中文** | [English](quality-lessons.md)

# 质量控制办法（历史实践提炼）

> **定位**：本文件是**规范表**（正向目标/负面限制），作为 QC 六道关的设计依据。
> **特定情况的实战经验**（判据/处置/验证）另见 `skills/auto-epublizer/lessons/`
> （每篇一主题，如扫描件/MinerU/翻译工作流）——两者互补：规范表定标准，
> lessons 提供「遇到具体源站/脏源/边界情况怎么判怎么修」。
> **来源**：见下方两份历史工作成果。
